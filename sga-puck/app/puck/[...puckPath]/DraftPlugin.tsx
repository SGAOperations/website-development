...
export const DraftPlugin = {
  name: "draft-plugin", // Globally unique name
  label: "Drafts", // Plugin rail label
  icon: <PencilLine />, // Icon for plugin rail
  render: () => DraftPluginComponent
};

export function DraftPluginComponent({
  path,
  data,
  pageId,
  draftId,
