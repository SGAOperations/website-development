...
//     image:
//       "https://images.squarespace-cdn.com/content/v1/5939fcd1db29d6ec60929205/ed9937c7-3ffc-4776-aa0a-ce0f6d1b5886/Mikhail+Ankudovych.jpeg?format=2500w",
//   };
//   const members = [
//     {
//       name: "Mia Netland",
...
//       image:
//         "https://images.squarespace-cdn.com/content/v1/5939fcd1db29d6ec60929205/93dd6c2c-db81-4e3b-ae34-1f23d7e81130/Mia+Netland.jpeg?format=2500w",
//     },
//     {
//       name: "Charlene Chow",
//       title: "Director of Global Experience",
//       image:
//         "https://images.squarespace-cdn.com/content/v1/5939fcd1db29d6ec60929205/9566da0a-7b77-4ecf-b452-703b52b79e18/Charlene+Chow.jpeg?format=2500w",
//     },
//     {
//       name: "Lindsay Hong",
//       title: "Director of Social Engagement",
//       image:
//         "https://images.squarespace-cdn.com/content/v1/5939fcd1db29d6ec60929205/6117e163-531b-407e-8341-2400f5e3021e/Lindsay+Hong.jpg?format=2500w",
//     },
    ...
    const fetchData = async () => {
      try {
        const userResponse = await fetch(
          "http://localhost:5000/api/users/division/Student Success"
        );
        const userData = await userResponse.json();

        if (Array.isArray(userData) && userData.length > 0) {
          setLeader(userData[0]);
          setMembers(userData.slice(1));
        }

        const committeeResponse = await fetch(
          "http://localhost:5000/api/committees/division/Student Success"
        );
    ...
    <>
      ...
      <div>
        ...
        <p className="text-center text-black mx-30 mt-6 mb-2">
          The Student Success Division focuses on supporting the holistic
          well-being, global experiences, and campus engagement of students.
          Through various committees and working groups, this Division advocates
          for mental and physical wellness, improving global student
          experiences, and enhancing campus culture and student engagement.
        </p>
        <h3 className="text-5xl font-bold text-sga-red text-center mt-16 mb-4">
          Division Leadership
        </h3>
      ...
      <p className="text-center text-sga-red">
        ...
        <a
          ...
          href="mailto:sgaStudentSuccess@northeastern.edu"
        >
          sgaStudentSuccess@northeastern.edu
        </a>
      </p>
      <div>
        <h3 className="text-5xl font-bold text-sga-red text-center mt-16 mb-4">
