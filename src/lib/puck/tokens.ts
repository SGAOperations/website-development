...
export const columnCount = defineToken({
  ...
  "1:2": { label: "1 : 2", classes: "grid-cols-[1fr_2fr]" },
  "2:1": { label: "2 : 1", classes: "grid-cols-[2fr_1fr]" },
  "1:3": { label: "1 : 3", classes: "grid-cols-[1fr_3fr]" },
  "3:1": { label: "3 : 1", classes: "grid-cols-[3fr_1fr]" },
  "3": { label: "3", classes: "grid-cols-3" },
  "1:2:1": { label: "1 : 2 : 1", classes: "grid-cols-[1fr_2fr_1fr]" },
  "1:3:1": { label: "1 : 3 : 1", classes: "grid-cols-[1fr_3fr_1fr]" },
  "1:1:2": { label: "1 : 1 : 2", classes: "grid-cols-[1fr_1fr_2fr]" },
  "1:1:3": { label: "1 : 1 : 3", classes: "grid-cols-[1fr_1fr_3fr]" },
  "2:1:1": { label: "2 : 1 : 1", classes: "grid-cols-[2fr_1fr_1fr]" },
  "3:1:1": { label: "3 : 1 : 1", classes: "grid-cols-[3fr_1fr_1fr]" },
